            ...
            <ul>
                <li data-transition="papercut,3dcurtain-horizontal,3dcurtain-vertical,flyin,turnoff,cubic" data-slotamount="7" data-masterspeed="1700" data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7">
                    ...
                    <div class="tp-caption medium_text lfl" data-x="34" data-y="161" data-speed="2200" data-start="800" data-easing="easeOutExpo">
                        <p style="font-weight: 300; font-size: 21px;">Es totalmente gratuita y ya esta disponible<br />
                            para móvil y tablet, en android o ios ...</p>
                    </div>
                ...
                <li data-transition="papercut,3dcurtain-horizontal,3dcurtain-vertical,flyin,turnoff,cubic" data-slotamount="7" data-masterspeed="300">
                    ...
                    <div class="tp-caption medium_text lfl" data-x="center" data-hoffset="119" data-y="center" data-voffset="4" data-speed="2200" data-start="2400" data-easing="easeOutExpo">
                        <p style="font-weight: 800; font-size: 21px; text-align: center">Conoce las rutas mas visitadas<br />
                            y la historia de cada rincón</p>
                    </div>
                    <div class="tp-caption pst_media7 lfl" data-x="center" data-hoffset="119" data-y="center" data-voffset="94" data-speed="2000" data-start="2500" data-easing="easeOutExpo">
                        <a href="contacto/" class="button-transparent">¡ Consúltanos !</a>
                    </div>
                </li>
            </ul>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Rutas Centro histórico
                                    </a>
                                </h4>
                            </div>
  ...
  los sitios más importantes y podras conocer su historia atraves de el tiempo, su cultura y que acontencimiento sucedieron en 
    el lugar.
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">Lugares de Hospedaje y comida
                                    </a>
                                </h4>
                            </div>
    ...
    Podras visualizar una gran variedad de lugares para hospedarse o tener una agradeble cena.
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseThree">Eventos relevantes 
...
Al igual que la biciruta para conocer los horarios y sitios de reunión
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <p>
                        Administración de tu negocio y publicación de tus productos sus caracteristicas precios y ofertas
